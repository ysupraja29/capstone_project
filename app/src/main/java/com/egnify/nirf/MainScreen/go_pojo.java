...
public class go_pojo implements Serializable {
    ...
    public ArrayList<sub_metric_pojo> getGo_sub() {
        return go_sub;
    }

    public void setGo_sub(ArrayList<sub_metric_pojo> go_sub) {
        this.go_sub = go_sub;
    }
    ...
    private ArrayList<sub_metric_pojo> go_sub;
}
