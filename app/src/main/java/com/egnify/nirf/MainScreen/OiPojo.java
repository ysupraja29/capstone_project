...
public class OiPojo implements Serializable {
    ...
    private ArrayList<SubMetricPojo> oi_sub;

    public ArrayList<SubMetricPojo> getOi_sub() {
        return oi_sub;
    }

    public void setOi_sub(ArrayList<SubMetricPojo> oi_sub) {
        this.oi_sub = oi_sub;
    }
