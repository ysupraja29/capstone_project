...
public class perception_pojo implements Serializable {
    ...
    public ArrayList<sub_metric_pojo> getPerception_sub() {
        return perception_sub;
    }

    public void setPerception_sub(ArrayList<sub_metric_pojo> perception_sub) {
    ...
    private ArrayList<sub_metric_pojo> perception_sub;
}
