...
public class tlr_pojo implements Serializable{
    ...
    public  ArrayList<sub_metric_pojo> getTlr_sub() {
        return tlr_sub;
    }

    public void setTlr_sub(ArrayList<sub_metric_pojo> tlr_sub) {
    ...
    private ArrayList<sub_metric_pojo> tlr_sub;
}
