...
public class rpc_pojo implements Serializable {
    ...
    public ArrayList<sub_metric_pojo> getRpc_sub() {
        return rpc_sub;
    }

    public void setRpc_sub(ArrayList<sub_metric_pojo> rpc_sub) {
    ...
    private ArrayList<sub_metric_pojo> rpc_sub;
}
