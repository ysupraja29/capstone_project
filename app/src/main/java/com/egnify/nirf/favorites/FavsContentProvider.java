...
import static com.egnify.nirf.Provider.MySQLiteHelper.TABLE_COLLEGEINFO;
...
public class FavsContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.egnify.nirf.contentprovider";
    private static final String BASE_PATH = "collegeinfo";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        // Set the table
        queryBuilder.setTables(TABLE_COLLEGEINFO);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            case TODOS:
                rowsDeleted = sqlDB.delete(TABLE_COLLEGEINFO, selection,
                        selectionArgs);
                break;
            case TODO_ID:
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriType) {
            case TODOS:
                rowsUpdated = sqlDB.update(TABLE_COLLEGEINFO,
                        values,
                        selection,
                        selectionArgs);
                break;
